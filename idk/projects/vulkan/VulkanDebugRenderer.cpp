...
namespace idk
{
	...
	struct VulkanDebugRenderer::pimpl
	{
		...
		pimpl(vgfx::VulkanDetail&& deets) :detail{ std::move(deets) } {};
	};


	
	void VulkanDebugRenderer::Init(GfxSystem& system, const idk::pipeline_config& config, const idk::uniform_info& uniform_info)
	{
