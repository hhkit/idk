...
namespace idk::ogl {
	...
	void OpenGLFontAtlas::Buffer(void* data, size_t buffer_size, ivec2 texture_size, TextureInternalFormat format, GLenum incoming_components, GLenum incoming_type)
	{
