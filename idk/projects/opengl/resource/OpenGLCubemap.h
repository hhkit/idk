...
namespace idk::ogl
{
	...
	public:
		...
		void Buffer(TextureTarget face_value, void* data, uvec2 size, TextureInternalFormat internal_format, GLenum color_components = GL_RGB, GLenum incoming_type = GL_UNSIGNED_BYTE);
