...
namespace ImGui
{
    ...
    IMGUI_API void          Separator(bool span_cols = true);                                           // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator. //EDIT JOSEPH
	...
	// Added by Joseph 29/10/2019 //Readded by IZHA after update to ImGui 1.74
	IMGUI_API void          ProgressBar(float fraction, const ImVec4& color, const ImVec2& size_arg = ImVec2(-1, 0), const char* overlay = NULL);
