...
namespace idk::win
{
	static hash_table<int,const char*> msg_names
	{
		{0x0000,"WM_NULL"},
{0x0001,"WM_CREATE"},
{0x0002,"WM_DESTROY"},
...
{0x001c,"WM_ACTIVATEAPP"},
	...
	string_view idk::win::GetMsgName(uint32_t msg_id)
	{
		string_view msg = "Unhandled Message";
		auto itr = msg_names.find(msg_id);

		return (itr != msg_names.end()) ? string_view{ itr->second } : msg;
	}
