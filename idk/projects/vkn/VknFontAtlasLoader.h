...
namespace idk::vkn
{
	...
	public:
		...
		void LoadFontAtlas(VknFontAtlas& texture, TextureFormat input_pixel_format, std::optional<FontAtlasOptions> options, const char* rgba32, size_t len, uivec2 size, hlp::MemoryAllocator& allocator, vk::Fence load_fence, bool isRenderTarget = false);
		void LoadFontAtlas(VknFontAtlas& texture, TextureFormat input_pixel_format, std::optional<FontAtlasOptions> options, string_view rgba32, uivec2 size, hlp::MemoryAllocator& allocator, vk::Fence load_fence, bool isRenderTarget = false);
	};
}