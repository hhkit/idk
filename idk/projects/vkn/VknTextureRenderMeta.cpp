...
namespace idk::vkn {
	...
	static const hash_table<TextureInternalFormat, vk::Format> cFormatMap
	{
		...
		{ TextureInternalFormat::R_8_I, vk::Format::eR8Uint },
		{ TextureInternalFormat::R_16_I, vk::Format::eR16Uint },
		{ TextureInternalFormat::R_32_I, vk::Format::eR32Uint },
		{ TextureInternalFormat::R_64_I, vk::Format::eR64Uint },
