...
namespace idk::vkn
{
	...
	inline BlitCompatFlags operator&(BlitCompatUsageMasks lhs, BlitCompatTileMasks rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator&(BlitCompatTileMasks lhs, BlitCompatUsageMasks rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator|(BlitCompatUsageMasks lhs, BlitCompatTileMasks rhs)
	...
	inline BlitCompatFlags operator&(BlitCompatFlags lhs, BlitCompatTileMasks rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator&(BlitCompatTileMasks lhs, BlitCompatFlags rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator|(BlitCompatFlags lhs, BlitCompatTileMasks rhs)
	...
	inline BlitCompatFlags operator&(BlitCompatUsageMasks lhs, BlitCompatFlags rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator&(BlitCompatFlags lhs, BlitCompatUsageMasks rhs)
	{
		return BlitCompatFlags{ s_cast<BlitCompatFlag_t>(lhs) & s_cast<BlitCompatFlag_t>(rhs) };
	}
	inline BlitCompatFlags operator|(BlitCompatUsageMasks lhs, BlitCompatFlags rhs)
