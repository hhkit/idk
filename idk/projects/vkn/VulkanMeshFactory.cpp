...
namespace idk::vkn
{
	...
	auto GenerateFSQInterleavedBuffers()
	{
			...
			std::vector<Vertex> vertices{
				Vertex{ vec3{  sz, sz, 0}, vec3{0, 0 ,1}, vec2{1, 0} },  // front
				Vertex{ vec3{  sz,-sz, 0}, vec3{0, 0 ,1}, vec2{1, 1} },  // front
				Vertex{ vec3{-sz, -sz, 0},  vec3{0, 0,1}, vec2{0, 1} },  // front
				Vertex{ vec3{-sz,  sz, 0},  vec3{0, 0,1}, vec2{0, 0} },  // front
			};
