...
namespace idk::vkn
{
	...
	struct CanvasRenderer
	{
		...
		void DrawCanvas(size_t& ui_elem_count, size_t& text_count, PipelineThingy& the_interface, const PostRenderData& state, RenderStateV2& rs, const vector<UIRenderObject>& canvas_data);
	};
}