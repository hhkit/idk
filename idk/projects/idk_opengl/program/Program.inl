...
namespace idk::ogl
{
	...
	bool Program::SetUniform(std::string_view uniform, const T& obj)
	{
		...
		if constexpr (std::is_same_v<T, ivec2>)  glProgramUniform2f(_program_id, loc, obj[0], obj[1]);
		if constexpr (std::is_same_v<T, ivec3>)  glProgramUniform3f(_program_id, loc, obj[0], obj[1], obj[2]);
		if constexpr (std::is_same_v<T, ivec4>)  glProgramUniform4f(_program_id, loc, obj[0], obj[1], obj[2], obj[3]);
