...
layout (input_attachment_index=1, set=2, binding=2) uniform subpassInput specular_light_accum_input;
layout (input_attachment_index=2, set=2, binding=3) uniform subpassInput specular_depth_input;
